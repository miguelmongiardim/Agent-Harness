...
from agent_harness.retrieval import LexicalRetriever


def test_lexical_retriever_is_deterministic(tmp_path: Path) -> None:
    index = tmp_path / "documents.jsonl"
    records = [
        {"source_id": "s2", "path": "b.md", "text": "beta add_numbers", "start_line": 1, "end_line": 1},
        {"source_id": "s1", "path": "a.md", "text": "alpha add_numbers", "start_line": 1, "end_line": 1},
    ]
