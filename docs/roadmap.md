...
`governance_findings.v1`. Phase 5 adds evidence command discovery,
...
semantics, and `evidence index` JSON output. Operator API/UI routes and
release-readiness gates remain
