...
```powershell
agent-harness release readiness --version 1.9.1 --ci-run-id <run-id>
```
...
19. Run `agent-harness release readiness --version 1.9.1`.
...
- `dist/agent_harness-1.9.1-*.whl` exists.
- `dist/agent_harness-1.9.1.tar.gz` exists.
...
- the final readiness report is generated for `version: 1.9.1`.
